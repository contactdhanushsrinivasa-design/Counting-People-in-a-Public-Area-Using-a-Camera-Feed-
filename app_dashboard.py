...
def show_login_page():
    ...
    with col2:
        ...
        <div style="text-align: center; padding: 40px 20px 20px 20px;">
            <h1 style="color: #1f77b4; margin-bottom: 10px; font-size: 2.5em;">🔐 Admin Login</h1>
            <p style="color: #666; margin-bottom: 30px; font-size: 1.1em;">Please enter your credentials to access the admin panel</p>
        </div>
        """, unsafe_allow_html=True)
...
page = st.sidebar.radio("Select View", ["Viewer Panel", "Video Analysis", "Admin Panel"])

# Appearance configuration in sidebar
st.sidebar.divider()
st.sidebar.markdown("### Appearance")
theme = st.sidebar.selectbox("Theme", ["light", "light-dark", "dark"], index=["light", "light-dark", "dark"].index(st.session_state.theme))
